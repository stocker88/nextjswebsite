    ...
    body: JSON.stringify({
      dynamicLinkInfo: {
        ...
        socialMetaTagInfo: {
            ...
            socialTitle:'StocksToBuyNow AI Sends You Hot Stocks Before They Blow Up: Maxout Profits 30x Faster',
            socialDescription: "Join a community of +110,000 investors"
        },
        analyticsInfo: {
          googlePlayAnalytics: {
