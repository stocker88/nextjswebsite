...
<br></br>
  ...
  <Image
            ...
            <br></br>
            <h1 className="text-4xl md:text-7xl tracking-tighter leading-tight" style={{ color: 'white', fontFamily: 'arial',lineHeight: 1.3,textShadow: '4px 4px 4px rgba(1, 74, 173, 0.6)', maxWidth: "640px" }} >
                                            Imagine someone told you about Nvidia when it was <b>$50 instead of $500</b>?
                                          </h1>
