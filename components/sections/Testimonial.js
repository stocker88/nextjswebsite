              ...
              <Image
                ...
                />
                 ...
                 <p className="text-1xl leading-relaxed mb-4" style={{'color':'lightgrey', padding:'1.5rem','textShadow': '0px 0px 3px rgba(0, 0, 0, 1)' , 'maxWidth':'650px', 'textAlign': 'left',}}>
                    ...
                    <b className="text-lg md:text-3xl font-bold mt-0 mb-12 center-content-mobile" style={{color:'lightGreen'}}> Receive Buy & Sell Signals on Stocks and on Options </b>
                    <br></br>
                   <br></br>
                 ...
                 <Image
                  ...
                  />
                   <p className="text-1xl leading-relaxed mb-4" style={{'color':'lightgrey', padding:'1.5rem','textShadow': '0px 0px 3px rgba(0, 0, 0, 1)' , 'maxWidth':'650px', 'textAlign': 'left',}}>
                      ...
                      <b className="text-lg md:text-3xl font-bold mt-0 mb-12 center-content-mobile" style={{color:'lightGreen'}}> Stock Recommendations that Drive Performance </b>
                      <br></br>
                      <br></br>
         ...
         <br></br>
          <a href='https://www.linkedin.com/in/fabienns/' target="_blank" >
             <Image
              ...
              <p className="text-1xl leading-relaxed mb-4" style={{'color':'lightgrey', padding:'1.5rem','textShadow': '0px 0px 3px rgba(0, 0, 0, 1)' , 'maxWidth':'650px', 'textAlign': 'left',}}>
                  <b className="text-lg md:text-3xl font-bold mt-0 mb-12 center-content-mobile" style={{color:'lightGreen'}}> Simple and Easy to Understand </b>
                  <br></br>
                 <br></br>
           ...
           <Image
            ...
            />
             <p className="text-1xl leading-relaxed mb-4" style={{'color':'lightgrey', padding:'1.5rem','textShadow': '0px 0px 3px rgba(0, 0, 0, 1)' , 'maxWidth':'650px', 'textAlign': 'left',}}>
                ...
                <b className="text-lg md:text-3xl font-bold mt-0 mb-12 center-content-mobile" style={{color:'lightGreen'}}> A Safe Playground for Learning </b>
                <br></br>
               <br></br>
