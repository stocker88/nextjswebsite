...
export default function Index({ allPosts }: Props) {
  ...
  return (
    <>
       ...
       <Home/>
        <Head>
          <title>HelloStocker: where ChatGPT meets Virtual Trading</title>
          <meta charSet="utf-8" />
          <meta name="p:domain_verify" content="f6f3f81b81f1d1573c7eaba7cc136a8b"/>
          <meta name="description" property="og:description" content="Learn how to invest in stocks with your personal finance advisor and practise with virtual trading for Financial Success! Personal finance is the art of budgeting and investing without risking money: earn passive income and unlock financial freedom with stock market and crypto strategies" />
          ...
          <meta name="twitter:title" content="HelloStocker: where ChatGPT Meets Virtual Trading"/>
