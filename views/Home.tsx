...
*/}
      ...
      <Container>
        <center style={{
          ...
          <div id="reviews" style={{marginLeft: '10%', marginRight: '10%', scrollMarginTop: '90px'}}>
            <div className="trustpilot-widget" data-locale="en-US" data-template-id="53aa8912dec7e10d38f59f36" data-businessunit-id="670a2355c53c6130a02f3e50" data-style-height="140px" data-style-width="100%" data-stars="4,5" data-theme="dark" data-review-languages="en" data-schema-type="Organization">
          ...
          <div style={{
            ...
            <a href="https://play.google.com/store/apps/details?id=com.newcompany.stocker" target="_blank" style={{ display: 'inline-flex', textDecoration: 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <Image src="/assets/images/androidstore.png" alt="StocksToBuyNow AI App" priority={true} width={156} height={156} style={{ borderRadius: '20px', opacity: 0.9, width: 'min(max(145px,13vw),200px)', height: 'min(max(145px,13vw),200px)' }} />
                <span style={{ fontWeight: 'bold', color: 'white', minWidth: '200px', fontSize: 'min(20px,max(18px,3.5vw)' }}>Android Store<br/>Reviews</span>
              </div>
            </a>
            ...
            <a href="https://apps.apple.com/us/app/stocks-to-buy-now-ai-signals/id1565527320" target="_blank" style={{ display: 'inline-flex', textDecoration: 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <Image src="/assets/images/applestore.png" alt="StocksToBuyNow AI App" priority={true} width={156} height={156} style={{ borderRadius: '20px', opacity: 0.9, width: 'min(max(145px,13vw),200px)', height: 'min(max(145px,13vw),200px)' }} />
                <span style={{ fontWeight: 'bold', color: 'white', minWidth: '200px', fontSize: 'min(20px,max(18px,3.5vw)' }}>Apple Store<br/>Reviews</span>
              </div>
            </a>
            ...
            <a href="https://www.linkedin.com/posts/anesshusseinali_multibagger-activity-7260416453328138242-S41Q" target="_blank" style={{ display: 'inline-flex', textDecoration: 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <Image src="/assets/images/linkedin.png" alt="Stocker AI Robot" priority={true} width={156} height={156} style={{ borderRadius: '20px', opacity: 0.9, width: 'min(max(145px,13vw),200px)', height: 'min(max(145px,13vw),200px)' }} />
                <span style={{ fontWeight: 'bold', color: 'white', minWidth: '200px', fontSize: 'min(20px,max(18px,3.5vw)' }}>LinkedIn<br/>&amp; CV</span>
              </div>
            </a>
          </div>
      ...
      <br></br>
        <Container>
        <div id="how-it-works" style={{ scrollMarginTop: '90px' }}>
        <IntroApp/>
        </div>
        </Container>
